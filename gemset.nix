{
  ...
  good_job = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "114wn77fnz4jg0xa0ahf6f4fzc2b3h5s0mlwdyplydb923z5szjk";
      type = "gem";
    };
    version = "4.9.3";
  };
  ...
  parser = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0r2dza2vg5f0v8waa6kgsv63s8mr7wnz0sv5qbx5a4fg6b0sq0sq";
      type = "gem";
    };
    version = "3.3.7.3";
  };
  ...
  sorbet-runtime = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1554ir2a6dn11yl0bihiwpg1xckzxk0whmc29g8d71ahgyc8wf61";
      type = "gem";
    };
    version = "0.5.11953";
  };
