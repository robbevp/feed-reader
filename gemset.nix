{
  ...
  sentry-rails = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "162w1lrn9jpzwyd4ada91pp1bks3vy2s87lwr8y13rmfpm0xa8pr";
      type = "gem";
    };
    version = "5.22.3";
  };
  sentry-ruby = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0yx4wdidkl3jyk1xp08jfr8w15hhq43sd5khkm2wxy3rbrvzgacg";
      type = "gem";
    };
    version = "5.22.3";
  };
  ...
  sorbet-runtime = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1zph8bpa8pgd56s6bhqriwrm31460am2nlbj0wfdqyfphagfpyaj";
      type = "gem";
    };
    version = "0.5.11801";
  };
