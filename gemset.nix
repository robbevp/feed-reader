{
  ...
  good_job = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1qvaj8c4s9jxr34icjyp08x39c3hqj8lq4kxhxn2lg1x55hb60f4";
      type = "gem";
    };
    version = "4.12.0";
  };
  ...
  sentry-rails = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "16r07h1y6p563jgqb66p0lj76494hbh7vasqdc5ba4mdwsf3smg7";
      type = "gem";
    };
    version = "5.27.0";
  };
  sentry-ruby = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "19sf061zclqjlj23fmva2drkixc7gr8bsrfpzvdkd2gfcmnh1r42";
      type = "gem";
    };
    version = "5.27.0";
  };
